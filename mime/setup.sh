...
mime_map["org.gnome.FileRoller.desktop"]="application/zip application/x-rar application/x-7z-compressed application/gzip application/x-bzip2 application/x-tar application/x-xz"
