...
static const char *fonts[]          = { "JetBrainsMono Nerd Font Mono:size=19" };
static const char dmenufont[]       = "JetBrainsMono Nerd Font Mono:size=19";
...
static const char *statusbarscript = "$DWM/scripts/statusbar.sh";
